...
def staging_pipeline():
    ...
    # df_store_branch['created_at'] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    ...
    load_staging(data=df_order_details, schema='public', table_name='order_detail', idx_name='order_detail_id')
